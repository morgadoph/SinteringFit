classdef TelaClass <handle
    %Classe de objetos para construção da interface 
    ...
    methods
        ...
        %Função que cria o toolbar na parte de cima da interface
        function Obj= CriaToolbar (Obj)
            ...
            ch = get(gcf,'children');
            UT = get(ch,'children');
            %Deleta ícones desnecessários do toolbar
            delete(UT(1));
            delete(UT(2));
            delete(UT(5));
            delete(UT(16));
        ...
        %Função que cria a janela do programa, com tamanho inicial e nome
        ...
        %Função para maximização da janela ao computador
        function Obj = Maximizee (Obj)
            %Chama função na pasta support
            maximize(gcf);
        end
        
        %Função para criação de layout, estrutura de frames, etc
        ...
        %Função utilizada como índice de cores a serem utilizadas no
        %programa
