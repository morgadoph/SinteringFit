...
% Last Modified by GUIDE v2.5 31-Aug-2012 00:37:38
...
function browse1_Callback(hObject, eventdata, handles)
    [arch1dato,padarch1dato] = uigetfile({'*.dat','arquivos de dados (*.dat)';}, ...
            'Carregue o arquivo');
    ...
    global arquivo1
    arquivo1 = load (arch1dato);
    assignin('base','arquivo1',arquivo1);
...
function browse2_Callback(hObject, eventdata, handles)
    ...
    assignin('base','arquivo2',arquivo2);
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    assignin('base','arquivo3',arquivo3);
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    assignin('base','arquivo4',arquivo4);
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    assignin('base','arquivo5',arquivo5);
