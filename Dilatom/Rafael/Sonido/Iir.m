...
% Fecha: Abril de 2009        
% Contenido:    Menú seleccion tipo filtro 
%               Se escoge que tipo de filtro Iir usar

function Iir
    
 %---------------------------------------------------------------------------------------------
 %------------------- PANTALLA DE MENU DE SELECCION DEL TIPO DE FILTRO IIR --------------------       
 %--------------------------------- ventana tipo Filtro Iir
 %-----------------------------------
...
W2=str2num(xW2);
   ...
   if (W1 > 1) || (W2 > 1) || (W1 > W2)|| (W1 <= 0) || (W1 <= 0)
    ...
    uicontrol('Parent',PFiltroFIR,...
        ...
        'String','   Tipo de Filtro IIR:', ...
        'Visible','on',...
        'Tag','TArchCodi');
        
    %Espacio Nombre del archivo Decodificado ----------------------------------------------- 
    tipoiir={'Butterworth' 'Chebyshev' 'Eliptico'};
    uicontrol('parent',PFiltroFIR, ...
        'Style','popupmenu', ...
        'Units','points', ...
