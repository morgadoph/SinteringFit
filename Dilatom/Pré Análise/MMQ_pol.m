function [param, chi2aj, chi2teo, var, k, C]=MMQ_pol (dadosx, dadosy, V, grau, ndados)
...
for k=grau:-1:1
    ...
    h = ztest( param(colunas,1),0,(param(colunas,2))^(1/2));                   %Efetua o teste z para parâmetro = 0 dentro da incerteza alfa=5%
    if h==1
        C=(V1\Xtrans)/V;
        break;
    end
